<template>
  Likes: {{ $store.state.likesModule.likes }}
  <div>
    <my-button @click="$store.commit('incrementLikes')">Add Likes</my-button>
    <my-button @click="$store.commit('decrementLikes')">Remove Likes</my-button>
  </div>
